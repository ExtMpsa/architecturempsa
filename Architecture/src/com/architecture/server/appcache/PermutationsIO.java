...
public final class PermutationsIO {
	...
	public static List<SelectionDescriptor> deserialize(final InputStream stream) throws Exception {
	...
	private static void handlePermutation(final List<SelectionDescriptor> descriptors, final Element permutationNode) throws Exception {
	...
	public static String serialize(final List<SelectionDescriptor> descriptors) throws Exception {
	...
	private static String transformDocumentToString(final Document document) throws Exception {
