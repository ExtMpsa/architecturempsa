...
public final class ManifestDescriptor {
	...
	public static ManifestDescriptor parse(final String manifest) throws IllegalArgumentException {
	...
	private static String urlDecode(final String line) throws IllegalStateException {
		try {
	...
	private String emitManifest() throws IllegalStateException {
	...
	private String urlEncode(final String path) throws IllegalStateException {
